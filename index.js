...
const totalGames = GAMES_JSON.reduce((sum, game) => sum + 1, 0);
...
const countUnfundedGame = GAMES_JSON.filter(game => game.pledged < game.goal).length;

// create a string that explains the number of unfunded games using the ternary operator
const displayStr = 
    `A total of $${totalRaised} has been raised for ${totalGames}. Currently, ${countUnfundedGame} games
